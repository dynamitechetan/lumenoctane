...
namespace Twid\Octane\Facades;

use Illuminate\Support\Facades\Facade;

/**
 * @method static \Twid\Octane\Swoole\InvokeTickCallable tick(string $key, callable $callback, int $seconds = 1, bool $immediate = true)
